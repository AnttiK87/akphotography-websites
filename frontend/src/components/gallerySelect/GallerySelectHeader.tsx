...
type GallerySelectHeaderProps = {
  heroText: string | undefined;
};

const GallerySelectHeader = ({ heroText }: GallerySelectHeaderProps) => {
    ...
    <div className="wholeScreen">
      ...
      <div className="ImageAndAnimationCont">
        {images === undefined ? (
          ...
          <>
            <div className={`maskImgPictures ${isImageReady ? "ready" : ""}`}>
              <img
                src={`/uploads/images/pictures/${images[currentImageIndex]}`}
...
export default GallerySelectHeader;
