...
const GalleryByCategory = () => {
  ...
  const TextByCategory = {
    ...
    mammals: {
      headerFi: "Nisäkkäät",
      headerEn: "Mammals",
      textContentFi: `Nisäkkäiden ja varsinkin isojen eläinten kuvaaminen on varmasti haastavinta. Eikä vähiten siksi, että niitä pääsee näkemään vain niin kovin harvoin. Ehkäpä myös siksi jo pelkkä eläimen näkeminen on aina erityinen kokemus. Isojen petoeläinten kuvaamiseen itselläni ei ole oikeastaan muita mahdollisuuksia kuin maksulliset piilokojut. Toki itse oman työn tuloksena kohdattu ja kuvattu eläin tuntuu ehkäåä enemmän ansaitulta. Silti on kyllä pakko myöntää, että mesikämmenen ihastelu suon laidalla pienestä kopista kesäyönä on myös kokemuksena vertaansa vailla.`,
